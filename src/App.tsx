...
const App: FC = () => {
  ...
  const [sortedMovies, setSortedMovies] = useState<MovieResponse[]>(() =>
    movies.data.sort(
      (a, b) =>
  ...
  return (
    <ErrorBoundary>
      ...
      <main>
        ...
        />
        <MoviesList moviesTotal={movies.totalAmount} movies={sortedMovies} />
      </main>
      <Footer />
      {isAddMovieOpened && <AddMovieModal onClose={hideAddMovieModal} />}
    </ErrorBoundary>
  )
}
